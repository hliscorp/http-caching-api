...
class CacheRequest
{
     ...
     */
    private function setMatchingEtag(string $etag): void
    {
     ...
     * @return string
     */
    public function getMatchingEtag(): string
    {
     ...
     * @param string $etag
     */
    private function setNotMatchingEtag(string $etag): void
    {
     ...
     * @return string
     */
    public function getNotMatchingEtag(): string
    {
     ...
     * @param string $date
     */
    private function setModifiedSince(string $date): void
    {
     ...
     * @return integer
     */
    public function getModifiedSince(): int
    {
     ...
     * @param string $date
     */
    private function setNotModifiedSince(string $date): void
    {
     ...
     * @return integer
     */
    public function getNotModifiedSince(): int
    {
     ...
     * @param string $value
     */
    private function setCacheControl(string $value): void
    {
        $p1 = explode(",", $value);
     ...
     * @param integer $value
     */
    private function setMaxAge(int $value): void
    {
     ...
     * @param integer $value
     */
    private function setMaxStaleAge(int $value): void
    {
     ...
     * @param integer $value
     */
    private function setMinFreshAge(int $value): void
    {
     ...
     * @return boolean
     */
    public function isNoTransform(): bool
    {
     ...
     * @return boolean
     */
    public function isCacheOnly(): bool
    {
     ...
     */
    private function _validateEtag(string $headerName, string $headerValue): string
    {
     ...
     * @param string $headerName
     * @param string $headerValue
     * @return integer Local UNIX time that matches requested date or null if not a valid date.
     */
    private function _validateDate(string $headerName, string $headerValue): int
    {
     ...
     */
    private function _validateNumber(string $headerName, string $headerValue): int
    {
